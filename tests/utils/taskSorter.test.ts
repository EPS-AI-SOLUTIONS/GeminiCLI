...
describe('Task Sorter Utilities', () => {
  describe('topologicalSort', () => {
    ...
    it('should sort tasks with linear dependencies', () => {
      const tasks = [createTask(3, [2]), createTask(2, [1]), createTask(1)];
    ...
    it('should handle diamond dependencies', () => {
      ...
      const tasks = [createTask(4, [2, 3]), createTask(3, [1]), createTask(2, [1]), createTask(1)];
    ...
    it('should handle multiple independent chains', () => {
      const tasks = [createTask(1), createTask(2, [1]), createTask(3), createTask(4, [3])];
  ...
  describe('validateDependencies', () => {
    it('should return empty array for valid dependencies', () => {
      const tasks = [createTask(1), createTask(2, [1]), createTask(3, [1, 2])];

      expect(validateDependencies(tasks)).toEqual([]);
    });

    it('should return missing dependency IDs', () => {
      const tasks = [createTask(1), createTask(2, [1, 999]), createTask(3, [888])];
    ...
    it('should report duplicate missing dependencies once each', () => {
      const tasks = [createTask(1, [999]), createTask(2, [999])];
  ...
  describe('hasCircularDependency', () => {
    ...
    it('should detect longer cycles (A -> B -> C -> A)', () => {
      const tasks = [createTask(1, [3]), createTask(2, [1]), createTask(3, [2])];
    ...
    it('should return false for diamond dependency (no cycle)', () => {
      const tasks = [createTask(1), createTask(2, [1]), createTask(3, [1]), createTask(4, [2, 3])];
