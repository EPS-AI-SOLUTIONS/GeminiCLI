...
export const useViewTheme = (): ViewTheme => {
  ...
  return useMemo(
    () => ({
      ...
      containerInner: isLight ? 'bg-white/40' : 'bg-black/40',
      ...
      header: isLight ? 'bg-white/50 backdrop-blur-xl' : 'bg-black/50 backdrop-blur-xl',
      headerTitle: isLight ? 'text-slate-800 font-bold' : 'text-white font-bold',
      headerSubtitle: isLight ? 'text-slate-500' : 'text-slate-400',
      headerIcon: isLight ? 'text-emerald-600' : 'text-matrix-accent',
      ...
      inputIcon: isLight ? 'text-slate-400' : 'text-slate-500',
      ...
      border: isLight ? 'border-slate-200/40' : 'border-white/10',
      divider: isLight ? 'border-t border-slate-200/30' : 'border-t border-white/5',

      scrollbar: isLight
        ? 'scrollbar-thin scrollbar-thumb-slate-300 scrollbar-track-transparent'
        : 'scrollbar-thin scrollbar-thumb-white/20 scrollbar-track-transparent',

      empty: isLight ? 'text-slate-400 italic' : 'text-slate-500 italic',
      loading: isLight ? 'text-emerald-600 animate-pulse' : 'text-matrix-accent animate-pulse',
      error: isLight
      ...
      accentBg: isLight ? 'bg-emerald-500/10' : 'bg-matrix-accent/10',
      accentText: isLight ? 'text-emerald-600' : 'text-matrix-accent',
      accentBorder: isLight ? 'border-emerald-500/30' : 'border-matrix-accent/30',
