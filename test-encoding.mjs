...
} from './src/native/EncodingUtils.ts';
...
console.assert(asciiResult.encoding === 'ascii', 'Expected ASCII encoding');
console.assert(asciiResult.confidence === 1.0, 'Expected 100% confidence');
...
console.assert(utf8BomResult.encoding === 'utf-8', 'Expected UTF-8 encoding');
console.assert(utf8BomResult.hasBOM === true, 'Expected BOM detected');
console.assert(utf8BomResult.confidence === 1.0, 'Expected 100% confidence');
...
console.assert(utf16leResult.encoding === 'utf-16le', 'Expected UTF-16LE encoding');
console.assert(utf16leResult.hasBOM === true, 'Expected BOM detected');
...
console.assert(polishResult.encoding === 'utf-8', 'Expected UTF-8 for Polish text');
...
console.assert(originalText === decoded, 'Roundtrip should preserve content');
...
console.assert(w1250Text === w1250Decoded, 'Windows-1250 roundtrip should work');
...
console.log('  ASCII BOM:', getBOMBytes('ascii')); // Should be null
