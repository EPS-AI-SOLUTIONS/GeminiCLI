...
Write-Host @"
  ...
  ╔═══════════════════════════════════════════════════════════════╗
  ║     AI MODEL HANDLER v2.0 - Auto Fallback & Optimization      ║
  ╠═══════════════════════════════════════════════════════════════╣
  ║  Features:                                                    ║
...
# Import Agent Swarm (The Witcher Edition)
$swarmPath = Join-Path $script:AIHandlerRoot "modules\AgentSwarm.psm1"
if (Test-Path $swarmPath) {
    Import-Module $swarmPath -Force -Global
    Write-Host "[OK] AgentSwarm module loaded (School of the Wolf)" -ForegroundColor Magenta
} else {
    Write-Host "[WARNING] AgentSwarm module not found" -ForegroundColor Yellow
}
