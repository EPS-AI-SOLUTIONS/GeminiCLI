 ...
 * ClaudeHydra - Full dark/light theme support with model tier badges
 */
...
const tierColors = {
  ...
  executor: {
    dark: 'text-white/80 bg-white/10 border-white/20',
  ...
  return (
    <div className="space-y-6 p-4 overflow-y-auto h-full">
      <div>
        ...
        <p
          className={`text-sm mt-1 ${isLight ? 'text-slate-700' : 'text-[var(--matrix-text-dim)]'}`}
        >
        ...
        return (
          <div key={tier}>
            <div className="flex items-center gap-2 mb-3">
              ...
              <span
                className={`text-xs ${isLight ? 'text-slate-600' : 'text-[var(--matrix-text-dim)]'}`}
              >
                  ...
                  >
                    <div className="flex items-start justify-between">
                      ...
                      <div className="flex flex-col items-end gap-1">
                        <div
                          className={`flex items-center gap-1 text-[9px] ${isLight ? 'text-emerald-600' : 'text-white/70'}`}
                        >
                    ...
                    <div>
                      ...
                      <p
                        className={`text-[10px] font-mono ${isLight ? 'text-slate-600' : 'text-[var(--matrix-text-dim)]'}`}
                      >
                    ...
                    <p
                      className={`text-xs leading-relaxed ${isLight ? 'text-slate-700' : 'text-[var(--matrix-text-dim)]'}`}
                    >
                      {meta.description}
                    </p>
                  </div>
