 ...
 * ClaudeHydra - Enhanced keyboard shortcuts display
 */
      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            >
              <div
                className={`flex items-center gap-2 ${isLight ? 'text-emerald-700' : 'text-[var(--matrix-accent)]'}`}
              >
                <Keyboard size={20} />
                ...
                <div key={group.title}>
                  <h3
                    className={`text-[10px] font-semibold uppercase tracking-wider mb-2 px-2 ${
                      isLight ? 'text-slate-600' : 'text-[var(--matrix-text-dim)]'
                    }`}
                  >
                    {group.title}
                  </h3>{' '}
                  <div className="space-y-0.5">
                    {group.shortcuts.map((s) => (
                      ...
                      >
                        <span
                          className={`text-sm ${isLight ? 'text-slate-700' : 'text-[var(--matrix-text)]'}`}
                        >
                          {s.desc}
                        </span>
                        <kbd
