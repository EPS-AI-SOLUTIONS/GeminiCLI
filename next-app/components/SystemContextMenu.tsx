...
/**
 * SystemContextMenu - Custom right-click context menu
 * ClaudeHydra - Swarm operations + standard clipboard actions
 */
...
export const SystemContextMenu = () => {
  ...
  useEffect(() => {
    const handleContextMenu = (e: MouseEvent) => {
      ...
      setContextData({ text: selection, isInput, target, isCommand });
  ...
  const dispatchAction = (action: string, content: string) => {
    const event = new CustomEvent('claude-context-action', {
