...
/**
 * ClaudeHydra - Skeleton Loading Components
...
import { type CSSProperties, forwardRef, type HTMLAttributes, useEffect } from 'react';
...
// SSR-safe style injection using useEffect
  ...
  (
    ...
    return (
      <div
        ...
        style={{ width, minHeight: height, ...style } as CSSProperties}
        {...props}
      >
