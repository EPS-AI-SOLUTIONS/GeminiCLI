/**
 * NativeFileSystem - Native filesystem operations for GeminiHydra
 * Replaces @modelcontextprotocol/server-filesystem
 *
 * Features:
 * - Fast, direct Node.js fs operations
...
// Re-export encoding types and functions
export {
  SupportedEncoding,
  EncodingInfo,
  ReadFileWithEncodingOptions,
...
export { FileLockError } from './types.js';
