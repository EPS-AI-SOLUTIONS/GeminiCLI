...
### Purpose
The gateway phase that transforms raw user input into a structured, analyzable format optimized for downstream processing.
...
- **Flag** technical terminology for special handling

#### 2. Task Classification
- **Categorize** task type: code, research, creative, analysis, multi-domain
- **Assess** complexity level: simple, moderate, complex, multi-phase
- **Identify** required capabilities and tools
- **Detect** implicit sub-tasks and dependencies

#### 3. Model Selection
- **Evaluate** task requirements against model capabilities
- **Select** optimal model chain for execution
